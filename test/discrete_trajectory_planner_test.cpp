...
namespace {
    ...
    TEST(DiscreteTrajectoryTest, EmptyRoad) {
        ...
        int simulate_steps=7, horizon_steps=5;
        ...
        vector<int> expected_path_s = {0,1,3,6,9,12,15,18,21};
        vector<int> expected_path_d = {2,2,2,2,2, 2, 2, 2, 2};
        vector<int> expected_path_v = {0,1,2,3,3, 3, 3, 3, 3};
